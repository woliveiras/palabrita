 ...
 * - Never reference these directly in UI. Use MaterialTheme.colorScheme or LocalGameColors instead.
...
object PalabritaColors {
  ...
  /**
   * Single-color reference for brand when a gradient is not possible (e.g. Material primary role,
   * icon tint).
   */
