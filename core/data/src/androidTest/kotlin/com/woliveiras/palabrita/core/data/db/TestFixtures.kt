...
fun createTestPlayerStatsEntity(
  ...
  maxUnlockedDifficulty: Int = 1,
  totalXp: Int = 0,
  playerTier: String = "NOVATO",
  gamesWonByDifficulty: String = "{}",
  winRateByDifficulty: String = "{}",
  consecutiveLossesAtCurrent: Int = 0,
  wordSizePreference: String = "DEFAULT",
