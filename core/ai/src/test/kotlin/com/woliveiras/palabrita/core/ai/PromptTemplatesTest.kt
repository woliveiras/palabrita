...
class PromptTemplatesTest {
  ...
  fun `puzzle user prompt gemma4 includes language parameter`() {
    val prompt = PromptTemplates.puzzleUserPromptGemma4(
      language = "pt", difficulty = 3, minLength = 6, maxLength = 7, recentWords = emptyList()
    )
  ...
  fun `puzzle user prompt gemma4 includes recent words`() {
    val prompt = PromptTemplates.puzzleUserPromptGemma4(
      language = "pt", difficulty = 2, minLength = 5, maxLength = 6,
  ...
  fun `puzzle prompt gemma3 includes JSON schema`() {
    val prompt = PromptTemplates.puzzlePromptGemma3(
      language = "en", difficulty = 1, minLength = 5, maxLength = 5, recentWords = emptyList()
    )
  ...
  fun `puzzle prompt gemma3 includes language output instruction`() {
    val prompt = PromptTemplates.puzzlePromptGemma3(
      language = "es", difficulty = 2, minLength = 5, maxLength = 6, recentWords = emptyList()
    )
  ...
  fun `difficulty 1 maps to everyday rarity`() {
    val prompt = PromptTemplates.puzzleUserPromptGemma4(
      language = "pt", difficulty = 1, minLength = 5, maxLength = 5, recentWords = emptyList()
    )
  ...
  fun `difficulty 5 maps to rare rarity`() {
    val prompt = PromptTemplates.puzzleUserPromptGemma4(
      language = "pt", difficulty = 5, minLength = 7, maxLength = 8, recentWords = emptyList()
    )
  ...
  fun `chat system prompt includes word and category`() {
    val prompt = PromptTemplates.chatSystemPrompt(word = "gatos", category = "animal", language = "pt")
    assertThat(prompt).contains("gatos")
  ...
  fun `chat system prompt includes language`() {
    val prompt = PromptTemplates.chatSystemPrompt(word = "cats", category = "animal", language = "en")
