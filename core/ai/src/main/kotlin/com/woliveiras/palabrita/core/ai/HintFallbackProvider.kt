...
/**
 * Generates generic template-based hints when the LLM fails. These hints are intentionally
 * vague but always valid — they never contain the target word and always produce exactly 3 hints.
 *
 * This guarantees 100% puzzle generation success: the word comes from a curated list and
 * hints always have a fallback.
 */
